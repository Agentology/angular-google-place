(function (global, factory) {
	...
	(factory((global['angular-google-place'] = {}),global.ng.core,global.ng.common));
...
var AngularGooglePlaceDirective = (function () {
    ...
    function AngularGooglePlaceDirective(el, service, ngZone) {
        ...
        this.ngZone = ngZone;
        this.changelogs = [];
        this.CountryCodes = new core.EventEmitter();
        this.TypesOptions = new core.EventEmitter();
        // unformatted address
        this.setAddress = new core.EventEmitter();
        // formatted address
        this.FormatAddress = new core.EventEmitter();
        this.street_number = new core.EventEmitter();
        this.postal_code = new core.EventEmitter();
        this.country = new core.EventEmitter();
        this.lat = new core.EventEmitter();
        this.lng = new core.EventEmitter();
        this.adr_address = new core.EventEmitter();
        this.formatted_address = new core.EventEmitter();
        this.name = new core.EventEmitter();
        this.place_id = new core.EventEmitter();
        this.types = new core.EventEmitter();
        this.url = new core.EventEmitter();
        this.utc_offset = new core.EventEmitter();
        this.vicinity = new core.EventEmitter();
        this.photos = new core.EventEmitter();
        this.street = new core.EventEmitter();
        this.city = new core.EventEmitter();
        this.state = new core.EventEmitter();
        this.district = new core.EventEmitter();
        /*
         NOT USED YET
...
AngularGooglePlaceDirective.propDecorators = {
    ...
    'CountryCodes': [{ type: core.Output },],
    'TypesOptions': [{ type: core.Output },],
    'setAddress': [{ type: core.Output },],
    'FormatAddress': [{ type: core.Output },],
    'street_number': [{ type: core.Output },],
    'postal_code': [{ type: core.Output },],
    'country': [{ type: core.Output },],
    'lat': [{ type: core.Output },],
    'lng': [{ type: core.Output },],
    'adr_address': [{ type: core.Output },],
    'formatted_address': [{ type: core.Output },],
    'name': [{ type: core.Output },],
    'place_id': [{ type: core.Output },],
    'types': [{ type: core.Output },],
    'url': [{ type: core.Output },],
    'utc_offset': [{ type: core.Output },],
    'vicinity': [{ type: core.Output },],
    'photos': [{ type: core.Output },],
    'street': [{ type: core.Output },],
    'city': [{ type: core.Output },],
    'state': [{ type: core.Output },],
    'district': [{ type: core.Output },],
...
exports.AngularGooglePlaceModule = AngularGooglePlaceModule;
exports.AngularGooglePlaceConstantService = AngularGooglePlaceConstantService;
exports.AngularGooglePlaceService = AngularGooglePlaceService;
exports.AngularGooglePlaceDirective = AngularGooglePlaceDirective;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=angular-google-place.umd.js.map
